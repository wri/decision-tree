...
Pipeline steps (per project):
  1. identify_polygon_tiles       — X_tile/Y_tile covering the project's polygons
  2. download_and_compute_slope   — compute per-tile slope GeoTIFF, cache at s3 dest
  3. compute_polygon_slope_stats  — zonal stats per polygon (numpy or exactextract)
  4. merge stats back into feats_df; apply_slope_classification runs downstream
"""
