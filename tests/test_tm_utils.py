...
def test_tm_features():
    ...
    features = _get_project_tm_features(project_ids)
...
#
#     cleaned_features = process_tm_results(PARAMS, features, GEOJSON_DIR)
#
#     # cleanup
#     delete_source_geojsons_file('468bee12-bfbc-4387-a00a-d7e915576427_07-14-2025.geojson')
#
...
#     features = _get_project_tm_features(project_ids)
#
#     cleaned_features = process_tm_results(PARAMS, features)
#
